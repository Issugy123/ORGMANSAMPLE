...
function renderProductTabs(product) {
  ...
  if (descriptionTab) {
    descriptionTab.innerHTML = `
      ...
      <p>${product.description}</p>
      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nunc vel tincidunt lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl. Sed euismod, nunc vel tincidunt lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl.</p>
      <p>Sed euismod, nunc vel tincidunt lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl. Sed euismod, nunc vel tincidunt lacinia, nisl nisl aliquam nisl, eget aliquam nisl nisl sit amet nisl.</p>
  ...
  if (detailsTab) {
    detailsTab.innerHTML = `
      ...
      <table class="product-details-table">
        ...
        <tr>
          <th>Ingredients</th>
          <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nunc vel tincidunt lacinia.</td>
        </tr>
        <tr>
          <th>How to Use</th>
          <td>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod, nunc vel tincidunt lacinia.</td>
...
/**
 * Set up event listeners for product detail
 * @param {Object} product - Product object
 */
...
// Add this function to handle opening the quick view modal
...
// Add this function to handle closing the quick view modal
...
// Add this function to set up event listeners for the quick view modal
 ...
 * @returns {string} - Random review comment
 */
